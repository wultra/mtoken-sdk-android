...
class JsonDeserializationTests {
  ...
  "responseObject": [
    ...
    fun `test real data 2`() {
        ...
        val operation = response.responseObject[0]
        Assert.assertEquals(11, operation.formData.attributes.size)
  ...
  "responseObject": [
    ...
    fun `test history response`() {
        ...
        UserOperationStatus.values().forEach { status ->
